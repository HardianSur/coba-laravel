        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card text-bg-dark ">
                    <img src="https://source.unsplash.com/500x500?<?php echo e($category->name); ?>" class="card-img-top" alt="<?php echo e($category->name); ?>">
                    <div class="card-img-overlay d-flex align-items-center p-0">
                        <h5 class="card-title text-center flex-fill p-4 bg-black fs-3" style="--bs-bg-opacity: .70;"><?php echo e($category->name); ?></h5>
                    </div>
                </div>
            </a>
            </div>
